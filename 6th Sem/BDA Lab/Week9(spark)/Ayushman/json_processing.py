...
df = spark.read.json("hdfs://localhost:9000/user/220968118/lab9/users.json")
...
filtered_df.write.mode("overwrite").json("hdfs://localhost:9000/user/220968118/lab9/filtered_users")

# Save grouped data as JSON to HDFS
grouped_df.write.mode("overwrite").json("hdfs://localhost:9000/user/220968118/lab9/grouped_by_city")
