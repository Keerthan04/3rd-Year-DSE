...
df = spark.read.option("header", "true").option("inferSchema", "true").csv("hdfs://localhost:9000/user/220968002/week9/sales.csv")
...
df_with_revenue.write.mode("overwrite").option("header", "true").csv("hdfs://localhost:9000/user/220968002/week9/with_revenue")
filtered_sales.write.mode("overwrite").option("header", "true").csv("hdfs://localhost:9000/user/220968002/week9/sales_above_500")
